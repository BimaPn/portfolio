...
const page = () => {
  return (
    <section className="mt-24 pb-36 relative"> 
      <div className="w-full lg:w-[1280px] px-8 mx-auto flexCenter flex-col">
        <div className="flex flex-col items-center relative z-[2]">
          <h1 className="text-[50px] font-bold text-white text-glow-lg">Europark Museum</h1>
          <span className="font-medium text-slate-300 text-lg">Web Application</span>
        </div>

        <div className="w-full h-[80vh] flexCenter -mt-6">
      ...
      <div className="w-full lg:w-[1280px] flex flex-col gap-20 mx-auto">
        <div className="flexCenter gap-7 py-4 relative z-[2]">
