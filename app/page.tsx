...
const Home = () => {
  return (
    <>
      ...
      <main>
        <section className="boxWidth h-screen relative overflow-hidden">
          <div 
          ...
          <div className="w-full h-full flexCenter gap-20 relative z-[1]">
            ...
            <div>
              <div className="w-[394px] aspect-[3.4/4] relative mt-3">
                <Image src={`/person.jpg`} alt="profile picture" fill className="object-cover z-[2]" />
                <div className="absolute -top-3 left-3 w-full h-full border-[3px] border-black z-0"/>
              </div>
            </div>
          </div>
        </section>    
